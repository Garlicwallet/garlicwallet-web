            ...
            <Layout>
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md={3} sm={{span:6, order:"first"}} xs={{span:8, order:"first"}}><Image className={"screen screen-left"}  src="/screen-recieve.png" fluid rounded/></Col>
                        <Col md={9}><h2>Store and receive Garlicoin Securely</h2>
                    ...
                    <Row className="justify-content-center">
                        <Col md={9}><h2>Send and Pay with Garlicoin</h2>
                        ...
                        <Col md={{span:3, order:"last"}} sm={{span:6, order:"first"}} xs={{span:8, order:"first"}}><Image className={"screen screen-right"}  src="/screen-send.png" fluid rounded/></Col>

                    </Row><p>Garlicwallet is fully open source. If you're interested in viewing the source code or compiling it yourself, you can find it on Github.</p>
                </Container>
            </Layout>
        </>
    )
